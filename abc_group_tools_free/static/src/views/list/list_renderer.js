...
Patch ADITIVO del ListRenderer: solo añade dos métodos nuevos; ningún método nativo se sobreescribe. La plantilla heredada (list_renderer.xml) decide dónde se usan. 
El patch se aplica una sola vez y es reversible (applyPatchOnce de abc_web_utils).
